...
namespace Inscripciones.Controllers
{
    ...
    public class ApiDetalleInscripcionesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<DetalleInscripcion>>> GetdetalleInscripcion()
        {
            return await _context.detalleInscripcion.ToListAsync();
        }
        ...
        {
            _context.detalleInscripcion.Add(detalleInscripcion);
            await _context.SaveChangesAsync();
